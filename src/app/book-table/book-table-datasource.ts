 ...
 */
export class BookTableDataSource extends DataSource<IBook> {
  // tslint:disable-next-line: variable-name
  private _dataStream = new BehaviorSubject<IBook[]>([]);
  public set books(v: IBook[]) { this._dataStream.next(v); }
  public get books(): IBook[] { return this._dataStream.value; }
